...
const NAV_ITEMS = [
  ...
  { href: "/admin/gallery", label: "Selected Stories", icon: Images },
  { href: "/admin/albums", label: "Featured Albums", icon: BookImage },
  { href: "/admin/stories", label: "Visual Stories", icon: Newspaper },
