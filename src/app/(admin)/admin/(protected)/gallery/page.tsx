...
export default async function GalleryPage() {
  ...
  const records: EditableRecord[] = (data ?? []).map((item) => ({ id: item.id, title: item.title, description: item.caption, location: item.location, date: item.shot_date, mediaId: item.media_id, categoryId: item.category_id, altText: item.alt_text }));
